...
```javascript
UINT32_NUM_BYTES = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-uint32-num-bytes@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-uint32-num-bytes@umd/bundle.js"></script>
```
